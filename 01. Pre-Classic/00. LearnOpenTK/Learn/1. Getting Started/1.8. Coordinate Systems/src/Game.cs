...
namespace LearnOpenTK.src {
    internal class Game : GameWindow {
        ...
        protected override void OnLoad() {
            ...
            float[] vertices = {
                // ..:: Positive X ::..
                x1, y1, z1,  1.0f, 0.0f, // 0
                x1, y1, z0,  1.0f, 1.0f, // 1
                x1, y0, z0,  0.0f, 1.0f, // 2
                x1, y0, z0,  0.0f, 1.0f, // 1
                x1, y0, z1,  0.0f, 0.0f, // 2
                x1, y1, z1,  1.0f, 0.0f, // 3
                
                // ..:: Negative X ::..
                x0, y1, z1,  1.0f, 0.0f, // 0
                x0, y1, z0,  1.0f, 1.0f, // 1
                x0, y0, z0,  0.0f, 1.0f, // 2
                x0, y0, z0,  0.0f, 1.0f, // 1
                x0, y0, z1,  0.0f, 0.0f, // 2
                x0, y1, z1,  1.0f, 0.0f, // 3
                
                // ..:: Positive Y ::..
                x0, y1, z0,  0.0f, 1.0f, // 0
                x1, y1, z0,  1.0f, 1.0f, // 1
                x1, y1, z1,  1.0f, 0.0f, // 2
                x1, y1, z1,  1.0f, 0.0f, // 1
                x0, y1, z1,  0.0f, 0.0f, // 2
                x0, y1, z0,  0.0f, 1.0f, // 3

                // ..:: Negative Y ::..
                x0, y0, z0,  0.0f, 1.0f, // 0
                x1, y0, z0,  1.0f, 1.0f, // 1
                x1, y0, z1,  1.0f, 0.0f, // 2
                x1, y0, z1,  1.0f, 0.0f, // 1
                x0, y0, z1,  0.0f, 0.0f, // 2
                x0, y0, z0,  0.0f, 1.0f, // 3

                // ..:: Positive Z ::..
                x0, y0, z1,  0.0f, 0.0f, // 0
                x1, y0, z1,  1.0f, 0.0f, // 1
                x1, y1, z1,  1.0f, 1.0f, // 2
                x1, y1, z1,  1.0f, 1.0f, // 1
                x0, y1, z1,  0.0f, 1.0f, // 2
                x0, y0, z1,  0.0f, 0.0f, // 3 

                // ..:: Negative Z ::..
                x0, y0, z0,  0.0f, 0.0f, // 0
                x1, y0, z0,  1.0f, 0.0f, // 1
                x1, y1, z0,  1.0f, 1.0f, // 2
                x1, y1, z0,  1.0f, 1.0f, // 1
                x0, y1, z0,  0.0f, 1.0f, // 2
                x0, y0, z0,  0.0f, 0.0f, // 3                               
            };
            //*/
