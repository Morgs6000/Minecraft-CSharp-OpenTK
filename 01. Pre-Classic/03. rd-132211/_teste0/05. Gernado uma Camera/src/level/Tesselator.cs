...
namespace RubyDung.src.level {
    ...
    //    public void flush() {
        public void flush() {
            ...
            GL.BufferData(BufferTarget.ArrayBuffer, this.texCoordBuffer.Length * sizeof(float), this.texCoordBuffer, BufferUsageHint.StreamDraw);
    ...
    //    }
        ...
        public void use() {            
            ...
            GL.DrawElements(PrimitiveType.Triangles, this.triangleBuffer.Length, DrawElementsType.UnsignedInt, 0);
        }
    ...
    //            this.texCoordBuffer.put(this.vertices * 2 + 0, this.u).put(this.vertices * 2 + 1, this.v);
                this.texCoordBuffer[vertices * 2] = u;
                this.texCoordBuffer[vertices * 2 + 1] = v;
                //        }
            }
