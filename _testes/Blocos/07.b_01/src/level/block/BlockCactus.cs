...
public class BlockCactus : Block {
    ...
    protected override void renderFace(Tesselator t, int x, int y, int z, string face) {
        ...
        t.vertex(x0 + 0.0625f, y1, z0);
        t.vertex(x0 + 0.0625f, y1, z1);
        ...
        t.vertex(x1 - 0.0625f, y1, z1);
        t.vertex(x1 - 0.0625f, y1, z0);
        ...
        t.vertex(x1, y1, z0 + 0.0625f);
        t.vertex(x0, y1, z0 + 0.0625f);
        ...
        t.vertex(x0, y1, z1 - 0.0625f);
        t.vertex(x1, y1, z1 - 0.0625f);
