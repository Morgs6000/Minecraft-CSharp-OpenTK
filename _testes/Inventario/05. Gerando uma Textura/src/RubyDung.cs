...
public class RubyDung : GameWindow {
    ...
    private Vector2 position = Vector2.Zero; // posição inicial do triângulo
    private bool isDragging = false;
    private Vector2 initialMousePosition;
    private Vector2 initialTrianglePosition;
    ...
    protected override void OnRenderFrame(FrameEventArgs args) {
        ...
        // aplicar a transformação de posição
    ...
    private void processInput() {
        ...
        if(mouseState.IsButtonDown(MouseButton.Left)) {
            if(!isDragging) {
                ...
                initialTrianglePosition = position;
            }
            else {
                // continuar o arrasto
                var currentMousePosition = new Vector2(mouseState.X, mouseState.Y);
                var delta = currentMousePosition - initialMousePosition;
                position = initialTrianglePosition + delta * 0.01f; // ajuste a velocidade conforme necessário
            }
        }
        else {
            // terminar o arrasto
