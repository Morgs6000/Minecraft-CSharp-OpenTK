...
using RubyDung.src.level.render;

namespace RubyDung.src.level.block;

public class Block {
    public static Block grass = new Block().setTexture(0, 0).setColor(0.0f, 1.0f, 0.0f);
    ...
    public static Block stoneDoubleSlab = new Block().setTexture(5, 0);
    public static Block stoneSlab = new Block().setTexture(6, 0);
    public static Block brick = new Block().setTexture(7, 0);
    public static Block tnt = new Block().setTexture(8, 0);
    public static Block web = new Block().setTexture(11, 0);
    public static Block plantRed = new Block().setTexture(12, 0);
    public static Block plantYellow = new Block().setTexture(13, 0);
    public static Block sapling = new Block().setTexture(15, 0);
    ...
    public static Block wood = new Block().setTexture(4, 1);
    ...
    public static Block mushroomRed = new Block().setTexture(12, 1);
    public static Block mushroomBrown = new Block().setTexture(13, 1);
    public static Block sapling_jungle = new Block().setTexture(14, 1);
    public static Block fire = new Block().setTexture(15, 1);
    ...
    public static Block bookShelf = new Block().setTexture(3, 2);
    public static Block cobblestoneMossy = new Block().setTexture(4, 2);
    public static Block obsidian = new Block().setTexture(5, 2);
    public static Block tallGrass = new Block().setTexture(7, 2).setColor(0.0f, 1.0f, 0.0f);
    public static Block beacon = new Block().setTexture(9, 2);
    public static Block stoneOvenIdle = new Block().setTexture(12, 2);
    public static Block dispenser = new Block().setTexture(14, 2);
    ...
    public static Block leaves = new Block().setTexture(4, 3);
    public static Block leaves_opaque = new Block().setTexture(5, 3);
    public static Block stoneBrick = new Block().setTexture(6, 3);
    public static Block deadBush = new Block().setTexture(7, 3);
    public static Block fern = new Block().setTexture(8, 3).setColor(0.0f, 1.0f, 0.0f);
    public static Block workbench = new Block().setTexture(11, 3);
    public static Block stoneOvenActive = new Block().setTexture(13, 3);
    public static Block sapling_spruce = new Block().setTexture(15, 3);
    ...
    public static Block cactus = new Block().setTexture(6, 4);
    public static Block blockClay = new Block().setTexture(8, 4);
    public static Block reed = new Block().setTexture(9, 4);
    public static Block music = new Block().setTexture(10, 4);
    public static Block jukebox = new Block().setTexture(11, 4);
    public static Block waterlily = new Block().setTexture(13, 4);
    public static Block mycelium = new Block().setTexture(14, 4);
    public static Block sapling_birch = new Block().setTexture(15, 4);
    ...
    public static Block crops_wheat_0 = new Block().setTexture(8, 5);
    public static Block crops_wheat_1 = new Block().setTexture(9, 5);
    public static Block crops_wheat_2 = new Block().setTexture(10, 5);
    public static Block crops_wheat_3 = new Block().setTexture(11, 5);
    public static Block crops_wheat_4 = new Block().setTexture(12, 5);
    public static Block crops_wheat_5 = new Block().setTexture(13, 5);
    public static Block crops_wheat_6 = new Block().setTexture(14, 5);
    public static Block crops_wheat_7 = new Block().setTexture(15, 5);
    ...
    public static Block stem = new Block().setTexture(15, 6).setColor(0.0f, 1.0f, 0.0f);
    ...
    public static Block wood_spruce = new Block().setTexture(4, 7);
    public static Block wood_birch = new Block().setTexture(5, 7);
    ...
    public static Block stem_0 = new Block().setTexture(15, 7).setColor(0.0f, 1.0f, 0.0f);
    ...
    public static Block leaves_spruce = new Block().setTexture(4, 8).setColor(0.0f, 1.0f, 0.0f);
    public static Block leaves_spruce_opaque = new Block().setTexture(5, 8).setColor(0.0f, 1.0f, 0.0f);
    public static Block melon = new Block().setTexture(8, 8);
    public static Block mushroomStem = new Block().setTexture(13, 8);
    public static Block vine = new Block().setTexture(15, 8).setColor(0.0f, 1.0f, 0.0f);
    ...
    public static Block wood_jungle = new Block().setTexture(9, 8);
    ...
    public static Block crops_0 = new Block().setTexture(8, 12);
    public static Block crops_1 = new Block().setTexture(9, 12);
    public static Block crops_2 = new Block().setTexture(10, 12);
    public static Block crops_carrot = new Block().setTexture(11, 12);
    public static Block crops_potato = new Block().setTexture(12, 12);
    ...
    public static Block nether_wart_0 = new Block().setTexture(2, 14);
    public static Block nether_wart_1 = new Block().setTexture(3, 14);
    public static Block nether_wart_2 = new Block().setTexture(4, 14);
