...
public class Window : GameWindow {
    ...
    protected override void OnUpdateFrame(FrameEventArgs args) {
        ...
        Console.WriteLine($"Posição da Camera: {eye.X}, {eye.Y}, {eye.Z}");
        //Console.WriteLine($"Posição da Camera: {(int)eye.X}, {(int)eye.Y}, {(int)eye.Z}");
    }
    ...
    protected override void OnRenderFrame(FrameEventArgs args) {
        ...
        view *= Matrix4.CreateTranslation(0.0f, 0.0f, -0.1f);
