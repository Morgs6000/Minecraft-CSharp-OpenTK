...
public class Game : GameWindow {
    ...
    private void DrawGUI_crosshair_OnLoad() {
        ...
        view_crosshair *= Matrix4.CreateScale(48.0f / 4);
        view_crosshair *= Matrix4.CreateTranslation((float)(width / 2), (float)(height / 2), 0.0f);
        view_crosshair *= Matrix4.CreateTranslation(0.0f, 0.0f, -200.0f);
        ...
        // t_crosshair.Vertex( 0.5f,  0.05f, 0.0f);
        // t_crosshair.Vertex(-0.5f,  0.05f, 0.0f);
        t_crosshair.Vertex(-1.0f, -0.05f, 0.0f);
        t_crosshair.Vertex( 1.0f, -0.05f, 0.0f);
        t_crosshair.Vertex( 1.0f,  0.05f, 0.0f);
        t_crosshair.Vertex(-1.0f,  0.05f, 0.0f);
        t_crosshair.Indice();
        ...
        // t_crosshair.Vertex( 0.05f,  0.5f, 0.0f);
        // t_crosshair.Vertex(-0.05f,  0.5f, 0.0f);
        t_crosshair.Vertex(-0.05f, -1.0f, 0.0f);
        t_crosshair.Vertex( 0.05f, -1.0f, 0.0f);
        t_crosshair.Vertex( 0.05f,  1.0f, 0.0f);
        t_crosshair.Vertex(-0.05f,  1.0f, 0.0f);
        t_crosshair.Indice();
